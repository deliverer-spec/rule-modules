...
public class DataUtil {
	...
	private static String NONCLASS = "com.ciana.rule.engine.data.NoneRuleDataImpl";
	private static String DATA_DB_CLASS = "com.ciana.rule.engine.data.DBRuleDataImpl";
	private static String DATA_REST_CLASS = "com.ciana.rule.engine.data.RestRuleDataImpl";
	private static String DATA_INTF_CLASS = "com.ciana.rule.engine.data.IntfRuleDataImpl";
	private static String DATA_CACHE_CLASS = "com.ciana.rule.engine.data.CacheRuleDataImpl";
